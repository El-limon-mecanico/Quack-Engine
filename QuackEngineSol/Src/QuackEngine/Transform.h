...
//-GETTERS LOCALES: Sirven para obtener la posici�n de un objeto RELATIVA A SU PADRE. La posici�n guardada en el transform SIEMPRE ser� la relativa.
	//Estos m�todos devuelven la posici�n local con respecto al padre que guarda un objeto.
//-GETTERS GLOBALES: Sirven para obtener la posici�n de un objeto EN EL MUNDO. Estos m�todos devuelven la suma de la posici�n local + la posici�n local del padre.
...
#pragma endregion
//-SETTERS LOCALES: Sirven para cambiar la posici�n de un objeto RELATIVA A SU PADRE. La posici�n guardada en el transform SIEMPRE ser� la relativa.
	//Modifican la posici�n relativa al padre de manera directa, indicando a cuantas unidades debe estar alejado del padre.
//-SETTERS GLOBALES: Sirven para cambiar la posici�n de un objeto RELATIVA AL MUNDO. Estos m�todos modifican la posicion relativa al padre a trav�s de una
	//posici�n en coordenadas mundiales.
