...
set CEGUIDir=%~dp0\
set dllsMoveTo=%dependenciesDir%\..\bin


mkdir %CEGUIDir%\dependecies\build
cd %CEGUIDir%\dependecies\build
...
XCOPY /y /s .\dependencies %CEGUIDir%\cegui-0.8.7\dependencies

:: Por fin podemos hacer cosas sobre cegui
cd %CEGUIDir%\cegui-0.8.7
